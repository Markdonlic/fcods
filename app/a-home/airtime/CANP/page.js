    ...
    <div className="w-[768px] min-h-screen m-0">
      <div className="flex flex-col gap-3">
        ...
        <div className="w-full flex flex-col justify-center gap-3">
          <Providers name="Canada PublicMobile" code="CANP" link="#" />
          <div className="w-full flex flex-col justify-center px-4">
            ...
            <div className="flex flex-col justify-center py-4">
              ...
              >
                ...
                <option value="10">10CAD PIN</option>
                <option value="20">20CAD PIN</option>
                <option value="25">25CAD PIN</option>
                <option value="30">30CAD PIN</option>
                <option value="40">40CAD PIN</option>
                <option value="45">45CAD PIN</option>
                <option value="100">100CAD PIN</option>
                <option value="60">60CAD PIN</option>
              </select>
            </div>
