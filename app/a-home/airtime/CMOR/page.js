  ...
  return (
    <div className="w-full flex flex-col justify-center items-center gap-3">
      ...
      <div className="w-full flex flex-col justify-center gap-3">
        <Providers name="Cameroon Orange" code="CMOR" link="#" />
        <div className="w-full flex flex-col justify-center px-4">
          ...
          <div className="flex flex-col justify-center py-4">
            ...
            >
              ...
              <option value="1000">9850XAF Top Up</option>
              <option value="2000">1950XAF Top Up</option>
              <option value="2500">19700XAF Top Up</option>
              <option value="4000">3900XAF Top Up</option>
            </select>
          </div>
