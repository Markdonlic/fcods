  ...
  return (
    <div className="w-full flex flex-col justify-center items-center gap-3">
      ...
      <div className="w-full flex flex-col justify-center gap-3">
        <Providers name="DR Congo Orange" code="DRO" link="#" />
        <div className="w-full flex flex-col justify-center px-4">
          ...
          <div className="flex flex-col justify-center py-4">
            ...
            >
              <option selected value="9.75">
                9.75USD Top Up
              </option>
              <option value="19.50">19.50USD Top Up</option>
              <option value="3.90">3.90USD Top Up</option>
              <option value="39">39USD Top Up</option>
              <option value="7.80">7.80USD Top Up</option>
            </select>
          </div>
